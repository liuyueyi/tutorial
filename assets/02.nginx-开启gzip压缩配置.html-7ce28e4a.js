import{_ as i,V as n,W as e,a1 as s}from"./framework-094145d2.js";const a={},l=s(`<p>ngxin 开启gzip压缩，减少数据包大小，默认场景下nginx没有开启gzip压缩，需要主动指定</p><p>关键配置修改如下（进入配置文件 nginx.conf)</p><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>http {
	# ...
