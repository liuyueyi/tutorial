import{_ as e,V as n,W as s,Y as a}from"./framework-b1bd8911.js";const i={},d=a(`<p>nginx配置完毕之后，添加一个html页面，访问直接500错误，通过查看错误日志，显示 <code>failed (13: Permission denied)</code></p><p>解决方法，修改配置文件中的<code>user</code>为<code>root</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/nginx/nginx.conf
