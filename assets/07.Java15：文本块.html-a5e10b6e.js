import{_ as n,V as s,W as a,a1 as e}from"./framework-094145d2.js";const t={},i=e(`<h1 id="java-15新特性-文本块-代码书写的新利器" tabindex="-1"><a class="header-anchor" href="#java-15新特性-文本块-代码书写的新利器" aria-hidden="true">#</a> Java 15新特性：文本块，代码书写的新利器！</h1><h2 id="传统字符串拼接的痛点" tabindex="-1"><a class="header-anchor" href="#传统字符串拼接的痛点" aria-hidden="true">#</a> 传统字符串拼接的痛点</h2><p>嘿，Java开发者们！有没有遇到过这样的烦恼：写代码时，字符串拼接写得自己都快崩溃了？比如，写SQL查询语句或者HTML代码片段，一不小心就拼错，还得花时间去排查问题。这事儿是不是特别烦人？</p><p>想象一下，你正在写一个SQL查询语句，代码可能是这样的：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token class-name">String</span> sql <span class="token operator">=</span> <span class="token string">&quot;SELECT * FROM users &quot;</span> <span class="token operator">+</span>
