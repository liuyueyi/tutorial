import{_ as e,V as n,W as s,a0 as a}from"./framework-23f3cf9b.js";const i={},l=a(`<p>直接使用influx-cli查询数据时，时间戳格式不太友好，记录下显示日期的方式</p><p><strong>连接时添加参数</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>influx <span class="token parameter variable">-precision</span> rfc3339
